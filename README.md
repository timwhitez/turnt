...
| Zoom                 | 🔒&nbsp;[Patched](docs/zoom.md)   | Zoom has since patched the technique we documented. Fully documented but requires manual steps in Burp Suite to obtain the TURN credentials from the webclient. |
